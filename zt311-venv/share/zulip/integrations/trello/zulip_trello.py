...
try:
    ...
    print(
        "Error: Please install the python requests library before running this script:"
    )
...
"""
    ...
    parser.add_argument(
        "--trello-board-name", required=True, help="The Trello board name."
    )
    parser.add_argument(
        "--trello-board-id",
        required=True,
        help=(
            "The Trello board short ID. Can usually be found "
