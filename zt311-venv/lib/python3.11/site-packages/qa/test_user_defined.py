...
class UserDefinedRuleTests(BaseTestCase):
    ...
    def test_user_defined_rules_examples1(self):
        ...
        self.assertEqualStdout(
            output,
            self.get_expected("test_user_defined/test_user_defined_rules_examples_1"),
        )
    ...
    def test_user_defined_rules_examples2(self):
        ...
        self.assertEqualStdout(
            output,
            self.get_expected("test_user_defined/test_user_defined_rules_examples_2"),
        )
    ...
    def test_user_defined_rules_examples_with_config(self):
        ...
        expected_path = (
            "test_user_defined/test_user_defined_rules_examples_with_config_1"
        )
    ...
    def test_user_defined_rules_extra(self):
        ...
        self.assertEqualStdout(
            output,
            self.get_expected(
                "test_user_defined/test_user_defined_rules_extra_1",
