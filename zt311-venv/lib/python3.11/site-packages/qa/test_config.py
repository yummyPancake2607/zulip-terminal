...
class ConfigTests(BaseTestCase):
    ...
    def test_ignore_by_id(self):
        ...
        output = gitlint(
            "--ignore", "T5,B4", _tty_in=True, _cwd=self.tmp_git_repo, _ok_code=[1]
        )
    ...
    def test_config_from_file(self):
        ...
        output = gitlint(
            "--config", config_path, _cwd=self.tmp_git_repo, _tty_in=True, _ok_code=[5]
        )
        self.assertEqualStdout(
    ...
    def test_config_from_file_debug(self):
        ...
        for target_repo in repos:
            ...
            self.assertEqualStdout(
                output,
                self.get_expected(
                    "test_config/test_config_from_file_debug_1", expected_kwargs
                ),
            )
    ...
    def test_config_from_env(self):
        ...
        self.assertEqualStdout(
            output,
            self.get_expected("test_config/test_config_from_env_1", expected_kwargs),
        )
        ...
        self.assertEqualStdout(
            output,
            self.get_expected("test_config/test_config_from_env_2", expected_kwargs),
        )
