...
class OlmDevice(object):
    ...
    def __init__(
        self, api, user_id, device_id, signed_keys_proportion=1, keys_threshold=0.1
    ):
        ...
        self.one_time_keys_manager = OneTimeKeysManager(
            target_keys_number, signed_keys_proportion, keys_threshold
        )
    ...
    def upload_one_time_keys(self, force_update=False):
        ...
        self.olm_account.generate_one_time_keys(
            signed_keys_to_upload + unsigned_keys_to_upload
        )
