...
_InputStream: TypeAlias = (
    _UnicodeInputStream | _BinaryInputStream
)  # noqa: Y047  # used in other files
...
class HTMLUnicodeInputStream:
    ...
    def charsUntil(
        self, characters: Iterable[str | bytes | bytearray], opposite: bool = False
    ) -> str: ...
...
class EncodingBytes(bytes):
    ...
    def skip(
        self, chars: bytes | bytearray | Iterable[bytes] = ...
    ) -> bytes | None: ...
