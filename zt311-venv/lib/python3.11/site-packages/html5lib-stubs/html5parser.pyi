...
@overload
def parse(
    doc: _InputStream, treebuilder: str, namespaceHTMLElements: bool = True, **kwargs
): ...
def parseFragment(
    doc: _InputStream,
    container: str = "div",
...
class HTMLParser:
    ...
    def parseError(
        self, errorcode: str = "XXX-undefined-error", datavars=None
    ) -> None: ...
    ...
    def parseRCDataRawtext(
        self, token, contentType: Literal["RAWTEXT", "RCDATA"]
    ) -> None: ...
