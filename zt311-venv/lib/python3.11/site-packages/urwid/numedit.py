    ...
    def __init__(self, caption="", default=None, base=10):
        ...
        if default is not None:
            if not isinstance(default, (int, str, Decimal)):
                raise ValueError(
                    "default: Only 'str', 'int', " "'long' or Decimal input allowed"
                )
            ...
            if isinstance(default, str) and len(default):
                ...
                if not re.match(validation_re, str(default), re.IGNORECASE):
                    raise ValueError(
                        "invalid value: {} for base {}".format(default, base)
                    )
        ...
        super(IntegerEdit, self).__init__(
            allowed_chars, caption, val, trimLeadingZeros=(self.base == 10)
        )
...
class FloatEdit(NumEdit):
    ...
    def __init__(
        self, caption="", default=None, preserveSignificance=True, decimalSeparator="."
    ):
        """
        caption -- caption markup
        default -- default edit value
    ...
    def value(self):
        ...
        if self.edit_text:
            ...
            ip, fp = ([v for v in self.edit_text.split(self._decimalSeparator)] + [0])[
                0:2
            ]
