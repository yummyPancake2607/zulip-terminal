...
DEC_SPECIAL_CHARMAP = {}
assert len(DEC_SPECIAL_CHARS) == len(ALT_DEC_SPECIAL_CHARS), repr(
    (DEC_SPECIAL_CHARS, ALT_DEC_SPECIAL_CHARS)
)
...
input_sequences = (
    ...
    + [
        ...
        for digit, key in zip(
            "235678", ("insert", "delete", "page up", "page down", "home", "end")
        )
    ]
    ...
    + [
        ...
        for letter, key in zip(
            "ABCDEFGH", ("up", "down", "right", "left", "5", "end", "5", "home")
        )
    ]
    + [
