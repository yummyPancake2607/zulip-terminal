...
class EditTest(unittest.TestCase):
    ...
    def ktest(self, e, key, expected, pos, desc):
        ...
        assert got == expected, "%s.  got: %r expected:%r" % (desc, got, expected)
    ...
    def test_utf8_input(self):
        ...
        self.assertEqual(self.t1.edit_text, "û".encode("utf-8"))
...
class EditRenderTest(unittest.TestCase):
    def rtest(self, w, expected_text, expected_cursor):
        ...
        assert text == expected_text, "got: %r expected: %r" % (text, expected_text)
