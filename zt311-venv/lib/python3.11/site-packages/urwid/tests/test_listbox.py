...
class ListBoxCalculateVisibleTest(unittest.TestCase):
    def cvtest(
        self, desc, body, focus, offset_rows, inset_fraction, exp_offset_inset, exp_cur
    ):
        ...
        assert offset_inset == exp_offset_inset, "%s got: %r expected: %r" % (
            desc,
            offset_inset,
            exp_offset_inset,
        )
        assert cursor == exp_cur, "%s (cursor) got: %r expected: %r" % (
            desc,
            cursor,
            exp_cur,
        )
    ...
    def test1_simple(self):
        ...
        self.cvtest("simple top position", l, 3, 0, (0, 1), 0, None)

        self.cvtest("simple middle position", l, 3, 1, (0, 1), 1, None)

        self.cvtest("simple bottom position", l, 3, 2, (0, 1), 2, None)

        self.cvtest("straddle top edge", l, 3, 0, (1, 2), -1, None)

        self.cvtest("straddle bottom edge", l, 3, 4, (0, 1), 4, None)

        self.cvtest("off bottom edge", l, 3, 5, (0, 1), 4, None)

        self.cvtest("way off bottom edge", l, 3, 100, (0, 1), 4, None)

        self.cvtest("gap at top", l, 0, 2, (0, 1), 0, None)

        self.cvtest("gap at top and off bottom edge", l, 2, 5, (0, 1), 2, None)

        self.cvtest("gap at bottom", l, 6, 1, (0, 1), 4, None)

        self.cvtest("gap at bottom and straddling top edge", l, 4, 0, (1, 2), 1, None)
        ...
        self.cvtest(
            "gap at top and bottom", [T(""), T(""), T("")], 1, 2, (0, 1), 1, None
        )
    ...
    def test2_cursor(self):
        ...
        self.cvtest("plain cursor in view", l1, 3, 1, (0, 1), 1, (1, 3))

        self.cvtest("cursor off top", l2, 3, 0, (1, 3), 0, (2, 0))

        self.cvtest("cursor further off top", l2, 3, 0, (2, 3), 0, (2, 0))

        self.cvtest("cursor off bottom", l1, 3, 3, (0, 1), 2, (1, 4))

        self.cvtest("cursor way off bottom", l1, 3, 100, (0, 1), 2, (1, 4))
...
class ListBoxChangeFocusTest(unittest.TestCase):
    ...
    def test1unselectable(self):
        ...
        self.cftest("simple unselectable", l, 2, 0, None, None, None, 0, (0, 1), None)

        self.cftest("unselectable", l, 2, 1, None, None, None, 1, (0, 1), None)

        self.cftest("unselectable off top", l, 2, -2, None, None, None, 0, (2, 3), None)

        self.cftest(
            "unselectable off bottom", l, 3, 2, None, None, None, 2, (0, 1), None
        )
    ...
    def test2selectable(self):
        ...
        self.cftest("simple selectable", l, 2, 0, None, None, None, 0, (0, 1), None)

        self.cftest("selectable", l, 2, 1, None, None, None, 1, (0, 1), None)

        self.cftest("selectable at top", l, 2, 0, "below", None, None, 0, (0, 1), None)

        self.cftest(
            "selectable at bottom", l, 2, 2, "above", None, None, 2, (0, 1), None
        )

        self.cftest(
            "selectable off top snap", l, 2, -1, "below", None, None, 0, (0, 1), None
        )

        self.cftest(
            "selectable off bottom snap", l, 2, 3, "above", None, None, 2, (0, 1), None
        )

        self.cftest(
            "selectable off top no snap", l, 2, -1, "above", None, None, 0, (1, 3), None
        )
    ...
    def test3large_selectable(self):
        ...
        l = [T("\n"), S("\n\n\n\n\n\n"), T("\n")]
        self.cftest(
            "large selectable no snap", l, 1, -1, None, None, None, 0, (1, 7), None
        )

        self.cftest(
            "large selectable snap up", l, 1, -2, "below", None, None, 0, (0, 1), None
        )

        self.cftest(
            "large selectable snap up2", l, 1, -2, "below", None, 2, 0, (0, 1), None
        )
        ...
        self.cftest(
            "large selectable snap down", l, 1, 0, "above", None, None, 0, (2, 7), None
        )

        self.cftest(
            "large selectable snap down2", l, 1, 0, "above", None, 2, 0, (2, 7), None
        )
...
class ListBoxRenderTest(unittest.TestCase):
    def ltest(self, desc, body, focus, offset_inset_rows, exp_text, exp_cur):
        ...
        assert text == exp_text, "%s (text) got: %r expected: %r" % (
            desc,
            text,
            exp_text,
        )
...
class ListBoxKeypressTest(unittest.TestCase):
    ...
    def test1_up(self):
        ...
        self.ktest(
            "direct selectable both visible", "up", [S(""), S("")], 1, 1, 0, 0, None
        )
        ...
        key, lbox = self.ktest(
            "nothing above no scroll", "up", [S("")], 0, 0, 0, 0, None
        )
        assert key == "up"
        ...
        e.set_edit_pos(1)
        key, lbox = self.ktest(
            "edit cursor force scroll", "up", [e], 0, -1, 0, 0, (0, 0)
        )
    ...
    def test2_down(self):
        ...
        self.ktest(
            "direct selectable both visible", "down", [S(""), S("")], 0, 0, 1, 1, None
        )
        ...
        key, lbox = self.ktest(
            "nothing below no scroll", "down", [S("")], 0, 0, 0, 0, None
        )
        assert key == "down"
        ...
        self.ktest(
            "force focus unselectable", "down", [S(""), T("\n\n\n\n")], 0, 0, 1, 0, None
        )

        odd_e.set_edit_text("hi\n\n\n\n\n")
        self.ktest(
            "pathological cursor widget", "down", [odd_e, T("\n")], 0, 0, 1, 4, None
        )
        ...
        e.set_edit_pos(4)
        key, lbox = self.ktest(
            "edit cursor force scroll", "down", [e], 0, 0, 0, -1, (0, 4)
        )
    ...
    def test3_page_up(self):
        ...
        self.ktest("all visible fail", "page up", [T("a"), T("\n")], 0, 0, 0, 0, None)

        self.ktest("current ok fail", "page up", [T("\n\n"), S("hi")], 1, 3, 1, 3, None)
    ...
    def test4_page_down(self):
        ...
        self.ktest("all visible fail", "page down", [T("a"), T("\n")], 1, 1, 1, 1, None)

        self.ktest(
            "current ok fail", "page down", [S("hi"), T("\n\n")], 0, 0, 0, 0, None
        )
...
class ZeroHeightContentsTest(unittest.TestCase):
    ...
    def test_listbox_text_pile_page_down(self):
        lb = urwid.ListBox(
            urwid.SimpleListWalker([urwid.Text("above"), urwid.Pile([])])
        )
    ...
    def test_listbox_text_pile_page_up(self):
        lb = urwid.ListBox(
            urwid.SimpleListWalker([urwid.Pile([]), urwid.Text("below")])
        )
        lb.set_focus(1)
