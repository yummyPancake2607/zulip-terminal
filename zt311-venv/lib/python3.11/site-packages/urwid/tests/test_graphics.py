...
class BarGraphTest(unittest.TestCase):
    ...
    def test1(self):
        ...
        self.bgtest("simpler", [[0], [0]], 5, [1, 2], 5, [(5, [(0, 3)])])
        self.bgtest("simple", [[5]], 5, [1], 1, [(1, [(1, 1)])])
        self.bgtest(
            "2col-1", [[2], [0]], 5, [1, 2], 5, [(3, [(0, 3)]), (2, [(1, 1), (0, 2)])]
        )
        self.bgtest(
            "2col-2", [[0], [2]], 5, [1, 2], 5, [(3, [(0, 3)]), (2, [(0, 1), (1, 2)])]
        )
        self.bgtest(
            "2col-3",
            [[2], [3]],
        ...
        self.bgtest(
            "3col-2", [[4], [4], [4]], 5, [2, 1, 1], 5, [(1, [(0, 4)]), (4, [(1, 4)])]
        )
        self.bgtest(
            "3col-3",
            [[1], [2], [3]],
...
class SmoothBarGraphTest(unittest.TestCase):
    def sbgtest(self, desc, data, top, exp):
        urwid.set_encoding("utf-8")
        g = urwid.BarGraph(
            ["black", "red", "blue"], None, {(1, 0): "red/black", (2, 1): "blue/red"}
        )
        g.set_data(data, top)
    ...
    def test1(self):
        self.sbgtest(
            "simple", [[3]], 5, [(1, [(0, 5)]), (1, [((1, 0, 6), 5)]), (1, [(1, 5)])]
        )
        self.sbgtest(
            "boring", [[4, 2]], 6, [(1, [(0, 5)]), (1, [(1, 5)]), (1, [(2, 5)])]
        )
        self.sbgtest(
            "two", [[4], [2]], 6, [(1, [(0, 5)]), (1, [(1, 3), (0, 2)]), (1, [(1, 5)])]
        )
        self.sbgtest(
            "twos",
            [[3], [4]],
