...
class FillerTest(unittest.TestCase):
    def ftest(self, desc, valign, height, maxrow, top, bottom, min_height=None):
    ...
    def fetest(self, desc, valign, height):
        self.assertRaises(urwid.FillerError, lambda: urwid.Filler(None, valign, height))
    ...
    def test_values(self):
        ...
        self.ftest("fixed top, bottom", ("fixed top", 3), ("fixed bottom", 4), 17, 3, 4)
        self.ftest(
        ...
        self.ftest("fixed bottom, top", ("fixed bottom", 3), ("fixed top", 4), 17, 4, 3)
        self.ftest(
        ...
        self.ftest("middle relative 70 grow 8", "middle", ("relative", 70), 10, 1, 1, 8)
