...
class CanvasTest(unittest.TestCase):
    def ct(self, text, attr, exp_content):
        ...
        assert content == exp_content, "got: %r expected: %r" % (content, exp_content)
    ...
    def test2(self):
        self.ct2(["Hello"], None, 0, 0, 5, 1, None, [[(None, None, B("Hello"))]])
        self.ct2(["Hello"], None, 1, 0, 4, 1, None, [[(None, None, B("ello"))]])
        self.ct2(["Hello"], None, 0, 0, 4, 1, None, [[(None, None, B("Hell"))]])
        self.ct2(
            ["Hi", "There"],
            None,
            1,
        ...
        self.ct2(["Hi", "There"], None, 0, 0, 5, 1, None, [[(None, None, B("Hi   "))]])
        self.ct2(["Hi", "There"], None, 0, 1, 5, 1, None, [[(None, None, B("There"))]])
...
class ShardsTrimTest(unittest.TestCase):
    ...
    def test1(self):
        ...
        self.sttop(
            shards, 2, [(3, [(0, 2, 10, 3, None, "foo"), (0, 2, 5, 3, None, "bar")])]
        )
        self.strows(
            shards, 2, [(2, [(0, 0, 10, 2, None, "foo"), (0, 0, 5, 2, None, "bar")])]
        )
        ...
        self.sttop(
            shards, 5, [(3, [(0, 0, 10, 3, None, "bar"), (0, 5, 5, 3, None, "baz")])]
        )
        self.sttop(
            shards, 7, [(1, [(0, 2, 10, 1, None, "bar"), (0, 7, 5, 1, None, "baz")])]
        )
        self.strows(
            shards,
            7,
        ...
        self.strows(
            shards, 5, [(5, [(0, 0, 10, 5, None, "foo"), (0, 0, 5, 5, None, "baz")])]
        )
        self.strows(
            shards, 4, [(4, [(0, 0, 10, 4, None, "foo"), (0, 0, 5, 4, None, "baz")])]
        )
    ...
    def test2(self):
        ...
        self.stsides(
            shards, 6, 9, [(5, [(6, 0, 4, 5, None, "foo"), (0, 0, 5, 5, None, "bar")])]
        )
        self.stsides(
            shards, 6, 6, [(5, [(6, 0, 4, 5, None, "foo"), (0, 0, 2, 5, None, "bar")])]
        )
...
class CanvasJoinTest(unittest.TestCase):
    def cjtest(self, desc, l, expected):
        ...
        assert result == expected, "%s expected %r, got %r" % (desc, expected, result)
...
class CanvasOverlayTest(unittest.TestCase):
    ...
    def test1(self):
        ...
        self.cotest("full", "rz", [], "HI", [], 0, 0, [[(None, None, B("HI"))]])
