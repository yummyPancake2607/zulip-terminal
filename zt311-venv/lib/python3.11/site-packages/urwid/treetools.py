...
class TreeWidget(urwid.WidgetWrap):
    ...
    def update_expanded_icon(self):
        ...
        self._w.base_widget.widget_list[0] = [self.unexpanded_icon, self.expanded_icon][
            self.expanded
        ]
    ...
    def get_display_text(self):
        return self.get_node().get_key() + ": " + str(self.get_node().get_value())
...
class ParentNode(TreeNode):
    ...
    def get_child_index(self, key):
        try:
            ...
            errorstring = (
                "Can't find key %s in ParentNode %s\n" + "ParentNode items: %s"
            )
            raise TreeWidgetError(
                errorstring % (key, self.get_key(), str(self.get_child_keys()))
            )
