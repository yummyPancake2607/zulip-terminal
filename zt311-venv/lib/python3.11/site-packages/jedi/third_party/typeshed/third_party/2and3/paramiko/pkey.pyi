...
class PKey:
    ...
    END_TAG: Pattern[str]
    def __init__(
        self, msg: Optional[Message] = ..., data: Optional[str] = ...
    ) -> None: ...
    ...
    def from_private_key_file(
        cls: Any, filename: str, password: Optional[str] = ...
    ) -> PKey: ...
    @classmethod
    def from_private_key(
        cls, file_obj: IO[str], password: Optional[str] = ...
    ) -> PKey: ...
...
class PublicBlob:
    ...
    comment: str
    def __init__(
        self, type_: str, blob: bytes, comment: Optional[str] = ...
    ) -> None: ...
    @classmethod
