...
class BaseTestCase(unittest.TestCase):
    ...
    def gitcontext(commit_msg_str, changed_files=None):
        ...
        with patch("gitlint.git.git_commentchar") as comment_char:
            ...
            if changed_files:
                changed_file_stats = {
                    filename: GitChangedFileStats(filename, 8, 3)
    ...
    def assertRaisesRegex(self, expected_exception, expected_regex, *args, **kwargs):
        ...
        return super().assertRaisesRegex(
            expected_exception, re.escape(expected_regex), *args, **kwargs
        )
    ...
    def assertRaisesMessage(
        self, expected_exception, expected_msg
        ...
        try:
            ...
            raise self.fail(
                f"Expected '{expected_exception.__name__}' got '{exc.__class__.__name__}'"
            )
