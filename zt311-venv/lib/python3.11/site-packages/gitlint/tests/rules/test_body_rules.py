...
class BodyRuleTests(BaseTestCase):
    def test_max_line_length(self):
        ...
        expected_violation = rules.RuleViolation(
            "B1", "Line exceeds max length (81>80)", "å" * 81
        )
        ...
        # assert raise on 121
        expected_violation = rules.RuleViolation(
            "B1", "Line exceeds max length (121>120)", "å" * 121
        )
    ...
    def test_trailing_whitespace(self):
        ...
        # trailing space
        expected_violation = rules.RuleViolation(
            "B2", "Line has trailing whitespace", "å "
        )
        violations = rule.validate("å ", None)
        self.assertListEqual(violations, [expected_violation])
    ...
    def test_hard_tabs(self):
        ...
        # contains hard tab
        expected_violation = rules.RuleViolation(
            "B3", "Line contains hard tab characters (\\t)", "This is å\ttest"
        )
    ...
    def test_body_first_line_empty(self):
        ...
        expected_violation = rules.RuleViolation(
            "B4", "Second line is not empty", "nöt empty", 2
        )
    ...
    def test_body_missing(self):
        ...
        # body is too short
        expected_violation = rules.RuleViolation(
            "B6", "Body message is missing", None, 3
        )
