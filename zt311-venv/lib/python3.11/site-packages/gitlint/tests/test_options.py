...
class RuleOptionTests(BaseTestCase):
    def test_option_equality(self):
        ...
        self.assertNotEqual(
            option1, StrOption("tëst-option1", "åbc", "Test Dëscription")
        )
        self.assertNotEqual(
            option1, StrOption("tëst-option", "åbcd", "Test Dëscription")
        )
        self.assertNotEqual(
            option1, StrOption("tëst-option", "åbc", "Test Dëscription2")
        )
    ...
    def test_int_option(self):
        ...
        expected_error = (
            "Option 'tëst-name' must be a positive integer (current value: '-123')"
        )
        ...
        expected_error = (
            "Option 'tëst-name' must be a positive integer (current value: 'foo')"
        )
        with self.assertRaisesMessage(RuleOptionError, expected_error):
            option.set("foo")
    ...
    def test_boolean_option(self):
        ...
        for value in incorrect_values:
            with self.assertRaisesMessage(
                RuleOptionError, "Option 'tëst-name' must be either 'true' or 'false'"
            ):
                option.set(value)
