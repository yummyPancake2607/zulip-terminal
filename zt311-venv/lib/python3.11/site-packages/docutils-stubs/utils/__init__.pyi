...
def new_document(
    source_path: str, settings: optparse.Values | None = None
) -> document: ...
...
def assemble_option_dict(
    option_list: Iterable[tuple[str, str]],
    options_spec: Mapping[str, Callable[[str], Any]],
) -> dict[str, Any]: ...
...
def clean_rcs_keywords(
    ...
    keyword_substitutions: Iterable[tuple[Pattern[str], str]],
) -> None: ...
def relative_path(source: StrPath | None, target: StrPath) -> str: ...
@deprecated(
    "Deprecated and will be removed in Docutils 1.0. Use `get_stylesheet_list()` instead."
)
