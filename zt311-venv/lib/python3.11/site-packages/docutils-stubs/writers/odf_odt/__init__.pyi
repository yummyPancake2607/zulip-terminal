...
def fix_ns(
    tag: str, attrib: dict[str, str], nsdict: Unused
...
class TableStyle:
    ...
    def __init__(
        self, border: str | None = None, backgroundcolor: str | None = None
    ) -> None: ...
...
class ListLevel:
    ...
    nested_level: bool
    def __init__(
        self, level: int, sibling_level: bool = True, nested_level: bool = True
    ) -> None: ...
...
class Writer(writers.Writer[bytes]):
    ...
    def update_stylesheet(
        self, stylesheet_root, language_code: str | None, region_code: str | None
    ): ...
    def write_zip_str(
        self,
        zfile: zipfile.ZipFile,
        name: str,
        bytes_: str | SizedBuffer,
...
class ODFTranslator(nodes.GenericNodeVisitor):
    ...
    def extract_table_styles(
        self, styles_str: str | ReadableBuffer
    ) -> dict[str, TableStyle]: ...
    def get_property(self, stylenode: ElementTree.Element) -> str | None: ...
    def add_doc_title(self) -> None: ...
    def find_first_text_p(
        self, el: _ElementInterfaceWrapper
    ...
    def generate_content_element(
        self, root: _ElementInterfaceWrapper
    ) -> _ElementInterfaceWrapper: ...
    def setup_page(self): ...
    ...
    def append_child(
        ...
        tag: str,
        attrib: dict[str, str] | None = None,
        parent: _ElementInterfaceWrapper | None = None,
    ) -> _ElementInterfaceWrapper: ...
    def append_p(
        self, style: str, text: str | None = None
    ) -> _ElementInterfaceWrapper: ...
    ...
    def get_image_scaled_width_height(
        self, node: nodes.image, source
    ) -> tuple[Incomplete, Incomplete]: ...
    def get_page_width(self) -> float: ...
    def generate_figure(
        self, node: nodes.image, source, destination, current_element
    ): ...
    def generate_image(
        self,
        node: nodes.image,
        ...
        destination,
        current_element,
        frame_attrs: dict[str, str] | None = None,
    ): ...
    ...
    def visit_title(
        self, node: nodes.title, move_ids: int = 1, title_type: str = "title"
    ) -> None: ...
    ...
    def generate_admonition(
        self, node: nodes.Node, label: str, title: str | None = None
    ) -> None: ...
