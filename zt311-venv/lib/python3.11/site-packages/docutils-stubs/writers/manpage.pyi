...
class _RegexPatternSub(Protocol):
    ...
    def __call__(
        self, /, repl: str | Callable[[re.Match[str]], str], string: str, count: int = 0
    ) -> str: ...
...
class Translator(nodes.NodeVisitor):
    ...
    def visit_admonition(
        self, node: nodes.admonition, name: str | None = None
    ) -> None: ...
    ...
    def visit_comment(
        self, node: nodes.comment, sub: _RegexPatternSub = ...
    ) -> None: ...
