...
class HTMLTranslator(nodes.NodeVisitor):
    ...
    def prepare_svg(
        self, code: str | bytes, node: nodes.Element, atts: dict[str, Incomplete]
    ) -> str: ...
    def stylesheet_call(
        self, path: StrPath, adjust_path: bool | None = None
    ) -> str: ...
    def starttag(
        self,
        node: nodes.Element,
    ...
    def visit_comment(
        self, node: nodes.comment, sub: Callable[[str, str], str] = ...
    ) -> None: ...
