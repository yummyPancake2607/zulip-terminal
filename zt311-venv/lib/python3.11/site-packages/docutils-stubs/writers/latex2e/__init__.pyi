...
class Babel:
    ...
    def __init__(
        self, language_code: str, reporter: Reporter | None = None
    ) -> None: ...
...
class LaTeXTranslator(nodes.NodeVisitor):
    ...
    def insert_align_declaration(
        self, node: nodes.Element, default: str | None = None
    ) -> None: ...
    ...
    @overload
    @deprecated(
        "The `name` parameter is deprecated and will be removed in Docutils 0.24."
    )
    ...
    def to_latex_length(
        self, length_str: str, node: nodes.Node | None = None
    ) -> str: ...
    ...
    def visit_substitution_reference(
        self, node: nodes.substitution_reference
    ) -> None: ...
