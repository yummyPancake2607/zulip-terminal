...
@deprecated(
    "Deprecated and will be removed with the switch to from optparse to argparse."
)
def store_multiple(
    option: optparse.Option, opt: str, value, parser: OptionParser, *args: str, **kwargs
) -> None: ...
@deprecated(
    "Deprecated and will be removed with the switch to from optparse to argparse."
)
def read_config_file(
    option: optparse.Option, opt: str, value, parser: OptionParser
) -> None: ...
...
@deprecated(
    "The `frontend.make_one_path_absolute` will be removed in Docutils 2.0 or later."
)
...
class Values(optparse.Values):
    ...
    def update(
        self, other_dict: Values | Mapping[str, Incomplete], option_parser: OptionParser
    ) -> None: ...
...
class ConfigParser(RawConfigParser):
    ...
    @overload
    @deprecated(
        "The `option_parser` parameter is deprecated and will be removed in Docutils 0.24."
    )
    def read(
        self, filenames: str | Sequence[str], option_parser: OptionParser | None
    ) -> list[str]: ...
