...
class Node:
    ...
    @overload
    @deprecated(
        "The `nodes.Node.traverse()` is deprecated. Use `Node.findall()` instead."
    )
    def traverse(
        self,
        condition: type[_N],
...
class Element(Node):
    ...
    rawsource: str
    def __init__(
        self, rawsource: str = "", *children: Node, **attributes: Any
    ) -> None: ...
    ...
    def insert(
        self, index: SupportsIndex, item: Node | Iterable[Node] | None
    ) -> None: ...
    ...
    def validate_content(
        ...
        elements: Sequence[Incomplete] | None = None,
    ) -> list[Incomplete]: ...
...
class system_message(Special, BackLinkable, PreBibliographic, Element):
    def __init__(
        self, message: str | None = None, *children: Node, **attributes
    ) -> None: ...
    def astext(self) -> str: ...
...
class ValidationError(ValueError):
    def __init__(
        self, msg: str, problematic_element: Element | None = None
    ) -> None: ...
