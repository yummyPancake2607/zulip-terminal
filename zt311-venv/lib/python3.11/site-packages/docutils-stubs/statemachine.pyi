...
_TransitionMethod: TypeAlias = Callable[
    [Match[str], _Context, str], _TransitionResult[_Context]
]
...
class StateMachine(Generic[_Context]):
    ...
    def insert_input(
        self, input_lines: list[str] | StringList, source: str
    ) -> None: ...
...
class State(Generic[_Context]):
    ...
    debug: bool
    def __init__(
        self, state_machine: StateMachine[_Context], debug: bool = False
    ) -> None: ...
    def runtime_init(self) -> None: ...
    def unlink(self) -> None: ...
    ...
    def add_transition(
        self, name: str, transition: tuple[Pattern[str], str, str]
    ) -> None: ...
...
class ViewList(Generic[_T]):
    ...
    def insert(
        self, i: int, item: _T, source: str | None = None, offset: int = 0
    ) -> None: ...
...
class StringList(ViewList[str]):
    def trim_left(
        self, length: int, start: int = 0, end: int = sys.maxsize
    ) -> None: ...
