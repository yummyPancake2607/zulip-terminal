...
_DefinitionParts: TypeAlias = tuple[
    str, str, str, list[Pattern[str] | _BasicDefinition]
]
_DefinitionType: TypeAlias = tuple[str, str, str, list[Pattern[str] | _DefinitionParts]]

class Inliner:
    implicit_dispatch: list[
        tuple[Pattern[str], Callable[[Match[str], int], Sequence[nodes.Node]]]
    ]
...
class Body(RSTState):
    ...
    def build_table(
        self, tabledata, tableline, stub_columns: int = 0, widths=None
    ) -> nodes.table: ...
    ...
    def anonymous(
        self, match: Match[str], context: list[str] | None, next_state: str
    ): ...
