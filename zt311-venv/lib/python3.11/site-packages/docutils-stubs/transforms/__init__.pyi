...
_TransformTuple: TypeAlias = tuple[
    str, type[Transform], nodes.Node | None, dict[str, Any]
]
...
class Transform:
    ...
    def __init__(
        self, document: nodes.document, startnode: nodes.Node | None = None
    ) -> None: ...
    def __getattr__(
        self, name: str, /
    ) -> Incomplete: ...  # method apply is not implemented
...
class Transformer(TransformSpec):
    ...
    def add_pending(
        self, pending: nodes.pending, priority: int | None = None
    ) -> None: ...
