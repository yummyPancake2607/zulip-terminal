...
class Footnotes(Transform):
    ...
    def resolve_references(
        self, note: nodes.footnote, reflist: Iterable[nodes.footnote_reference]
    ) -> None: ...
    @overload
    def resolve_references(
        self, note: nodes.citation, reflist: Iterable[nodes.citation_reference]
    ) -> None: ...
    @overload
    def resolve_references(
        self, note: nodes.title, reflist: Iterable[nodes.title_reference]
    ) -> None: ...
...
class TargetNotes(Transform):
    ...
    def make_target_footnote(
        self, refuri: str, refs: list[Incomplete], notes: dict[Incomplete, Incomplete]
    ): ...
...
class DanglingReferencesVisitor(nodes.SparseNodeVisitor):
    ...
    def __init__(
        self, document: nodes.document, unknown_reference_resolvers
    ) -> None: ...
